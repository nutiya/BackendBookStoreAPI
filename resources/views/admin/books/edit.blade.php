...
<div class="container">
    ...
    <form action="{{ route('books.update', $book->id) }}" method="POST" novalidate>
        ...
        {{-- The selects for author, publisher, language, category --}}
        ...
        {{-- The rest of inputs similar to create, using old() with fallback to $book->value --}}
        ...
        <div class="mb-3">
            ...
            <input type="number" name="sold_count" id="sold_count" 
                ...
                value="{{ old('sold_count', $book->sold_count) }}" min="0"
            >
            @error('sold_count')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        ...
        <div class="mb-3">
            ...
            <input type="text" name="isbn" id="isbn" 
                ...
                maxlength="20" value="{{ old('isbn', $book->isbn) }}"
            >
            @error('isbn')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
